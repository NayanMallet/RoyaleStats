...
const CLASH_DATA_SERVICE_URL = process.env.CLASH_DATA_SERVICE_URL || 'http://clash-data-service:3004'
const LINK_SERVICE_URL = process.env.LINK_SERVICE_URL || 'http://link-service:3005'
const META_TRACKER_SERVICE_URL = process.env.META_TRACKER_SERVICE_URL || 'http://meta-tracker-service:3006'
...
function createServiceProxy(serviceName: string, target: string, pathRewrite?: Record<string, string>, extraOptions: any = {}) {
...
export const proxies = {
    ...
    royaleapi: createServiceProxy('RoyaleAPI Proxy', 'https://royaleapi.com', { '^/api/royaleapi': '' }, {
        headers: {
